...
public class InventarioController implements Serializable {
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage("¡Inventario creado con exito!");
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("¡Invenatario editado con exito!");
            return "List";
        } catch (Exception e) {
            JsfUtil.addSuccessMessage("¡Lo sentimos la operación no pudo completarse intente mas tarde!");
            return "List";
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage("¡Inventario eliminado con exito!");
        } catch (Exception e) {
            JsfUtil.addSuccessMessage("¡Lo sentimos la operación no pudo completarse intente mas tarde!");
        }
    }
