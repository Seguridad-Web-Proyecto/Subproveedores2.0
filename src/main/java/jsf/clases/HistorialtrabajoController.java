...
public class HistorialtrabajoController implements Serializable {
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage("¡Historial creado con exito!");
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("¡Historial editado con exito!");
            return "List";
        } catch (Exception e) {
            JsfUtil.addSuccessMessage("¡Lo sentimos la operación no pudo completarse intente mas tarde!");
            return "List";
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage("¡Historial eliminado con exito!");
